...
public interface MallOrderMapper {
    List<MallOrder> selectOrderList(MallOrder order); int countOrdersByMemberStatus(@Param("memberId") Long memberId,@Param("status") String status); List<MallOrder> selectExpiredPendingOrders(); MallOrder selectOrderById(Long orderId); MallOrder selectOrderByMemberNo(@Param("memberId") Long memberId,@Param("orderNo") String orderNo); MallOrder selectOrderByMemberRequest(@Param("memberId") Long memberId,@Param("clientRequestNo") String clientRequestNo); List<MallOrderItem> selectOrderItems(Long orderId);
