...
@Validated @RestController @RequestMapping("/app/shop") public class AppMemberOrderController extends BaseController {
 ...
 @PostMapping("/orders") public AjaxResult create(@Valid @RequestBody AppMemberOrderRequest request){return AjaxResult.success(orderService.createOrder(AppMemberContext.getMemberId(),request));}
